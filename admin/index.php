                ...
                <div class="panel blue-bg">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                               <span class="state-title"><a class="sst" href="agents.php">Events </a></span>
                ...
                <div class="panel green-bg">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                <span class="state-title"><a class="sst" href="agents.php"> List Places  </a></span>
    ...
    <div class="panel green-bg">
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-xs-8">
                    <span class="state-title"> <a class="sst" href="etc.php"> Users </a> </span> 
